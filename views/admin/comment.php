...
foreach ($comment as $k) {
   ...
   <div class="comment-main-admin <?='id' . $k->chapter_id?> <?=$k->authorCom?> <?='n' . $k->validate?>" id="<?=$class?>">
      <div class="comment-user-admin">
         <div class="comment-detail-admin">
            <img src="<?=URL.'/public/img/user.jpeg'; ?>" alt="">
            <p><?=$k->authorCom?></p>
         </div>
         <div class="comment-content-admin">
            <p class="<?='id' . $k->idCom?>"><?=$k->contentCom;?></p>
         </div>
      </div>

      <div class="comment-footer-admin">
